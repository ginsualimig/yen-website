...
const article: ExpandedArticle = {
  ...
  sections: [
    ...
    {
      title: 'Consumer Confidence & Income Trajectory',
      subsections: [
        {
          heading: 'Income Recovery & Labor Market Dynamics',
  ...
  references: [
    ...
    { number: 7, author: 'China Banking and Insurance Regulatory Commission', year: 2025, title: 'Personal Lending Standards and Regional Allocation Targets 2025', source: 'CBIRC, Beijing' },
    { number: 8, author: 'Sequoia Capital China', year: 2025, title: 'Consumer Tech and E-Commerce Investment Thesis for 2025–2026', source: 'Sequoia Capital China, Beijing' },
    { number: 9, author: 'Ministry of Commerce, PRC', year: 2025, title: 'Consumer Credit Expansion Programme and Subsidy Guidelines', source: 'MOFCOM, Beijing' },
    { number: 10, author: 'China Development Bank', year: 2025, title: 'Consumer Finance and Lending Strategy for Tier-2 and Tier-3 Cities', source: 'CDB, Beijing' },
  ],
  footnotes: [
    { term: 'Livestream E-Commerce', definition: 'Real-time video shopping experience where sellers demonstrate products and consumers can purchase instantaneously, combining entertainment, influencer dynamics, and instant checkout.' },
    { term: 'MPC (Marginal Propensity to Consume)', definition: 'The percentage of each additional unit of income that a household will spend on consumption; higher MPC for lower-income households indicates faster stimulus multiplier effects.' },
    { term: 'GMV', definition: 'Gross Merchandise Volume — total transaction value of goods sold on an e-commerce platform, including seller revenue before platform fees and logistics costs.' },
    { term: 'Gini Coefficient', definition: 'A statistical measure of income inequality ranging from 0 (perfect equality) to 1 (perfect inequality); China\'s Gini coefficient was approximately 0.47 in 2025.' },
    { term: 'Consumption Voucher', definition: 'Time-limited and category-specific digital or physical coupons distributed by governments, redeemable for specific goods or services, designed to boost immediate consumer spending.' },
  ],
};
